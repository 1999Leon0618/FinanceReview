...
import type { TrendChartProps } from "@/components/dashboard-trend-charts";
import {
  AlertTriangle,
  ArrowLeft,
  ArrowUpDown,
...
const HeroAssetChart = dynamic(() =>
  import("@/components/dashboard-trend-charts").then(
    (module) => module.HeroAssetChart,
  ),
);
...
) as <T extends { capturedAt: string }>(
  props: TrendChartProps<T>,
) => ReactElement;
const PerformancePanel = dynamic(() =>
  import("@/components/performance-panel").then(
    (module) => module.PerformancePanel,
  ),
);
const AccountSettingsEditor = dynamic(() =>
  import("@/components/account-settings-editor").then(
    (module) => module.AccountSettingsEditor,
  ),
);
const CreditCardEditor = dynamic(() =>
  import("@/components/credit-card-editor").then(
    (module) => module.CreditCardEditor,
  ),
);
