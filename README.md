...
全部賣出會在同一個資料庫交易內建立一份不含該持倉的新快照、調整指定帳戶並保存成本基礎及已實現損益。一般證券的淨入帳為成交總額減手續費與交易稅；期貨帳戶權益已包含最新快照的浮動損益，因此平倉時只以成交價相對最新快照現價的損益差額扣除費稅後調整權益，完整已實現損益仍以進場均價至成交價計算並保存在賣出紀錄。部分賣出仍請在新快照填寫目前剩餘數量與平均成本。
